    ...
    public class CollectScoresSystem : SystemBase
    {
        ...
        protected override void OnUpdate ( )
        {
            ...
            Entities
                ...
                .ForEach (( Entity entity, int entityInQueryIndex, ref DynamicBuffer <Unity.Physics.Stateful.StatefulTriggerEvent> a_triggerEventBuffer, ref NNBrainScoreComponent brainScore, ref VehicleControllsComponent controlls, ref VehicleVelocityComponent velocity, ref ShaderAlphaComponent alphaColor ) =>
            {
...
// Prevent NaN conditions. Unknown reason, why this occures.
                ...
                {
                    _ResetStates ( ref controlls, ref velocity, ref alphaColor, ref ecbp, entityInQueryIndex, entity ) ;
                    return ;
                }
